...
SAMPLE_RESUME = ResumePayload.model_validate(
    {
        "basics": {
            ...
            "summary": (
                "Results-driven AI/ML, backend, and data analytics engineer with hands-on experience "
                "building scalable APIs, analytics workflows, and machine-learning solutions. Strong "
                "in Python, FastAPI, Django, SQL, data visualization, and ATS-friendly resume writing."
            ),
        },
        "skills": [
